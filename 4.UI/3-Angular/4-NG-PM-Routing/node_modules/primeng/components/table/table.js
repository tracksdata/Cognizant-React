...
var Table = /** @class */ (function () {
            ...
            if (this.columnResizeMode === 'fit') {
                ...
                if (nextColumn) {
                    ...
                    if (newColumnWidth > 15 && nextColumnWidth > parseInt(nextColumnMinWidth)) {
                        ...
                        if (this.scrollable) {
                            var scrollableTable = this.domHandler.findSingle(this.el.nativeElement, 'table.ui-table-scrollable-body-table');
                            var colGroup = scrollableTable.children[0].nodeName === 'COLGROUP' ? scrollableTable.children[0] : null;
                            if (colGroup) {
                ...
                if (this.scrollable) {
                    ...
                    column.style.width = newColumnWidth + 'px';
                    var scrollableColGroup = scrollableBodyTable.children[0].nodeName === 'COLGROUP' ? scrollableBodyTable.children[0] : null;
    ...
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ], Table.prototype, "onRowClick", void 0);
    __decorate([
        core_1.Output(),
        __metadata("design:type", core_1.EventEmitter)
    ...
    ScrollableView.prototype.bindEvents = function () {
        ...
        this.zone.runOutsideAngular(function () {
            ...
            if (_this.scrollHeaderViewChild && _this.scrollHeaderViewChild.nativeElement) {
                if (!_this.frozen) {
                    _this.scrollHeaderBoxViewChild.nativeElement.style.marginRight = scrollBarWidth + 'px';
                }
            ...
            if (_this.scrollFooterViewChild && _this.scrollFooterViewChild.nativeElement) {
                if (!_this.frozen) {
                    _this.scrollFooterViewChild.nativeElement.style.marginRight = scrollBarWidth + 'px';
                }
